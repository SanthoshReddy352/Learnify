...
import { TrendingUp, X, Menu, Settings, Home, User, LogOut, Globe, BookOpen } from 'lucide-react'
    ...
    `}>
      ...
      <nav className="p-2 space-y-2 flex-1 overflow-y-auto custom-scrollbar">
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button 
              ...
              data-active={isActive('/resource-hub')}
            >
              <BookOpen className="h-5 w-5 flex-shrink-0" />
              {open && <span className="ml-3 truncate">Resource Hub</span>}
            </Button>
          </TooltipTrigger>
          {!open && <TooltipContent side="right">Resource Hub</TooltipContent>}
        </Tooltip>
        ...
        <Tooltip>
          ...
          {!open && <TooltipContent side="right">Community</TooltipContent>}
        </Tooltip>
        ...
        <Tooltip>
          ...
          {!open && <TooltipContent side="right">Profile</TooltipContent>}
        </Tooltip>
