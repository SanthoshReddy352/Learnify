      ...
      <div className="min-h-screen bg-background relative flex items-center justify-center overflow-hidden p-4 pt-[calc(1rem+env(safe-area-inset-top))] pb-[calc(1rem+env(safe-area-inset-bottom))] selection:bg-primary/20 selection:text-primary">
        ...
        <div className="relative z-10 w-full max-w-md">
          <Button
            variant="ghost"
            onClick={() => router.push('/')}
            className="mb-8 hover:bg-foreground/5 text-muted-foreground hover:text-foreground"
          >
            <ArrowLeft className="mr-2 h-4 w-4" />
            Back to Home
          </Button>

          <Card className="glass-card relative overflow-hidden border-border/60 shadow-2xl">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <Button
                  ...
                  className="glass border-border hover:border-border hover:bg-foreground/5"
                >
              ...
              <form onSubmit={handleEmailSignup} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                    className="border-border bg-foreground/5 text-foreground placeholder:text-muted-foreground/50 focus:border-primary/50"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                    minLength={6}
                    className="border-border bg-foreground/5 text-foreground focus:border-primary/50"
                  />
