          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <Button 
                ...
                className="glass border-border hover:bg-foreground/5 hover:border-border"
              >
            ...
            <form onSubmit={handleEmailLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  required
                  className="bg-foreground/5 border-border focus:border-primary/50 text-foreground"
                />
              </div>
              <Button 
                type="submit" 
