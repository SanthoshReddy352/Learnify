  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 selection:bg-primary/20 selection:text-primary relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="glass-card border-border/60 shadow-2xl relative overflow-hidden">
            ...
            <form onSubmit={handleResetPassword} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  required
                  className="bg-foreground/5 border-border focus:border-primary/50 text-foreground placeholder:text-muted-foreground/50"
                />
              </div>
              <Button 
                type="submit" 
