...
export default function CommunityPage() {
  ...
  return (
    <div className="space-y-8 pb-10">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-border/60 pb-8">
        ...
        <div className="relative w-full md:w-96">
            ...
            <Input 
                ...
                className="pl-10 h-11 bg-foreground/5 border-border focus:border-primary/50 focus:bg-foreground/10 transition-all rounded-xl"
                value={searchQuery}
      ...
      {filteredSubjects.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 border border-dashed border-border rounded-3xl bg-foreground/5">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredSubjects.map(subject => (
                <Card 
                    key={subject.id}
                    className="glass-card hover:bg-foreground/10 transition-all duration-300 cursor-pointer group border-border/60 hover:border-primary/30 flex flex-col h-full overflow-hidden relative"
                ...
                >
                    ...
                    <CardFooter className="bg-black/20 p-3 flex items-center justify-between relative z-10">
                        ...
                        <Button 
                            size="sm"
                            className="h-8 bg-foreground/5 hover:bg-foreground/10 text-foreground border border-border shadow-none hover:text-primary transition-all active:scale-95"
