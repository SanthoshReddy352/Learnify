...
function ClassroomJoinContent() {
  ...
  return (
    <div className="space-y-6">
      <section className="relative overflow-hidden rounded-[32px] border border-border bg-[linear-gradient(135deg,rgba(16,185,129,0.14),rgba(15,23,42,0.92)_52%,rgba(14,165,233,0.14))] px-5 py-6 shadow-[0_24px_80px_-52px_rgba(16,185,129,0.72)] sm:px-7 sm:py-7">
