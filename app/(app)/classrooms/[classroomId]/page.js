...
export default function ClassroomDetailPage() {
  ...
  return (
    <div className="space-y-6 md:space-y-8 pb-[calc(2rem+env(safe-area-inset-bottom))]">
      <section className="relative overflow-hidden rounded-[24px] md:rounded-[32px] border border-border bg-gradient-to-br from-primary/10 via-background to-sky-500/10 px-5 py-6 md:px-8 md:py-10 shadow-[0_20px_60px_-40px_rgba(59,130,246,0.4)]">
        ...
        <div className="relative flex flex-col gap-8 md:gap-10">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div className="max-w-3xl flex-1">
              <Button variant="ghost" size="sm" className="mb-4 -ml-2 text-muted-foreground hover:bg-foreground/5 hover:text-foreground" onClick={() => router.push('/classrooms')}>
            ...
            {highlightedCourse && (
              <Card className="w-full lg:max-w-[340px] xl:max-w-sm rounded-[20px] border-border bg-black/20 backdrop-blur-md shadow-xl shrink-0 overflow-hidden group">
                ...
                <CardContent className="p-4 md:p-5 space-y-4 relative z-10">
                  <div className="space-y-1.5 border border-border/60 bg-white/[0.02] p-3 rounded-xl">
                    ...
                    <div className="h-1.5 rounded-full bg-foreground/10 overflow-hidden">
                      ...
                      >
                         <div className="absolute top-0 right-0 bottom-0 w-4 bg-foreground/20 blur-[2px] rounded-full animate-[shimmer_2s_infinite]"></div>
                      </div>
                    </div>
                  </div>
                  <Button
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            <Card className="rounded-[16px] md:rounded-[20px] border-border/60 bg-white/[0.03] shadow-none hover:bg-white/[0.05] transition-colors">
      ...
      {detail.courses.length === 0 ? (
        ...
        <section className="grid gap-6 lg:gap-8 lg:grid-cols-[1fr_300px] xl:grid-cols-[minmax(0,1.6fr)_340px]">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
              {detail.courses.map((course) => {
                ...
                return (
                  <Card
                    key={course.id}
                    className="group flex h-full cursor-pointer flex-col rounded-[20px] md:rounded-[24px] border border-border/60 bg-gradient-to-b from-card/80 to-card/20 backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5 relative overflow-hidden"
                  ...
                  >
                    ...
                    <CardContent className="mt-auto p-4 md:p-5 pt-0 md:pt-0 space-y-4 md:space-y-5 relative z-10 w-full min-w-0">
                      <div className="space-y-2 border border-border/60 bg-black/20 rounded-xl p-3 md:p-3.5">
                        <div className="flex items-center justify-between text-xs font-medium text-muted-foreground">
                        ...
                        <div className="h-1.5 rounded-full bg-foreground/10 w-full overflow-hidden">
                          ...
                          >
                             <div className="absolute inset-0 bg-foreground/20 blur-[2px] opacity-0 group-hover:opacity-100 transition-opacity"></div>
                          </div>
                        </div>
                      </div>

                      <div className="grid grid-cols-2 gap-2 md:gap-3 text-sm">
                        <div className="rounded-xl flex items-center justify-between border border-border/60 bg-white/[0.02] px-3 py-2 md:px-4 md:py-3 group-hover:border-border transition-colors">
                      ...
                      <div className="flex items-center justify-between border-t border-border pt-4 text-xs md:text-sm text-muted-foreground">
          ...
          <div className="space-y-4 md:space-y-6">
            <Card className="rounded-[20px] md:rounded-[24px] border-border bg-card/50 backdrop-blur-sm shadow-lg overflow-hidden relative">
              ...
              <CardContent className="p-5 md:p-6 pt-2 md:pt-4 space-y-3 shrink-0 relative z-10 min-w-0">
                <div className="rounded-xl md:rounded-[18px] border border-border/60 bg-white/[0.02] p-3 md:p-4 hover:bg-white/[0.04] transition-colors overflow-hidden">
            ...
            {highlightedCourse && (
              <Card className="rounded-[20px] md:rounded-[24px] border-border bg-card/50 backdrop-blur-sm shadow-lg">
                ...
                <CardContent className="p-5 md:p-6 pt-2 md:pt-4 space-y-2 md:space-y-2.5 text-sm">
                  <div className="flex items-center justify-between rounded-xl border border-border/60 bg-white/[0.02] px-3.5 py-2.5 md:px-4 md:py-3 hover:bg-white/[0.04] transition-colors">
