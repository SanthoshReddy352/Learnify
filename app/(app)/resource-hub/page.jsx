...
function ResourceCard({ icon, title, description, onClick, color = "primary", badge = null }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative glass-card p-8 rounded-2xl border border-border group-hover:border-primary/50 bg-card/50 backdrop-blur-xl transition-all duration-300 flex flex-col h-full overflow-hidden">
        {badge && (
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="p-2 rounded-full bg-foreground/5 opacity-0 group-hover:opacity-100 transform translate-x-4 group-hover:translate-x-0 transition-all duration-300">
        ...
        <div className="mt-8 pt-6 border-t border-border/60 flex items-center justify-between text-xs font-semibold uppercase tracking-widest text-muted-foreground group-hover:text-primary transition-colors">
