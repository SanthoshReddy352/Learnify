          ...
          <div className="relative flex-1 md:w-72 group">
            ...
            <div className="relative">
              ...
              <Input 
                ...
                className="pl-10 h-11 bg-background/50 border-border focus:border-primary/50 backdrop-blur-md rounded-xl w-full"
              />
            </div>
          </div>
          <Button variant="outline" className="h-11 px-5 border-border hover:bg-foreground/5 bg-background/50 backdrop-blur-md rounded-xl transition-all hover:border-primary/30">
