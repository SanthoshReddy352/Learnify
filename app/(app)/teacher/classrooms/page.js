...
export default function TeacherClassroomsPage() {
  ...
  return (
    <>
      <section className="relative overflow-hidden rounded-[28px] border border-border bg-gradient-to-br from-primary/15 via-background to-emerald-500/10 px-6 py-7 shadow-[0_24px_80px_-48px_rgba(59,130,246,0.6)] md:px-8 md:py-8">
      ...
      {classrooms.length === 0 ? (
        <Card className="mt-8 rounded-[24px] border-dashed border-border bg-black/10">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {classrooms.map((classroom) => (
                <Card
                  key={classroom.id}
                  className="group flex h-full cursor-pointer flex-col rounded-[24px] border-border bg-gradient-to-br from-black/20 to-white/[0.03] transition-all hover:-translate-y-0.5 hover:border-primary/30"
                ...
                >
                  ...
                  <CardContent className="mt-auto space-y-4">
                    <div className="grid grid-cols-3 gap-3 text-sm">
                      <div className="rounded-2xl border border-border bg-white/[0.04] px-3 py-3">
