      ...
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 selection:bg-primary/20 selection:text-primary overflow-hidden">
        ...
        <div className="max-w-2xl w-full relative z-10 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
          ...
          <div className="mt-8 md:mt-12 flex flex-col-reverse md:flex-row justify-between items-center gap-4">
            ...
            >
              Previous
              <span className="ml-2 text-xs text-muted-foreground hidden md:inline-block border border-border px-1.5 rounded bg-black/20">←</span>
            </Button>
      ...
      <div className="border-b border-border bg-background/80 backdrop-blur-md sticky top-0 z-40 pt-[env(safe-area-inset-top)]">
        <div className="container mx-auto px-4 md:px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:block text-sm px-3 py-1 bg-foreground/5 rounded-full border border-border/60 text-muted-foreground">
          ...
          <CardContent className="p-4 md:p-6">
            <div className="text-center mb-4 md:mb-8">
                <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center mt-2 md:mt-4">
                    <Button variant="outline" onClick={() => setShowContent(!showContent)} className="glass border-border hover:bg-foreground/5 w-full sm:w-auto h-12 sm:h-auto">
                        {showContent ? 'Hide Content' : 'Show Content to Verify'}
                    </Button>
                    <Button variant="outline" onClick={handleShowFlashcards} className="glass border-border hover:bg-foreground/5 w-full sm:w-auto h-12 sm:h-auto">
              ...
              {showContent && (
                <div className="bg-foreground/5 p-4 md:p-8 rounded-xl border border-border/60 mt-6 text-left animate-in fade-in slide-in-from-bottom-2">
