...
export default function LandingPage() {
  ...
  return (
    ...
    >
      ...
      <section className="py-32 px-6">
        <div className="container mx-auto max-w-4xl text-center relative">
          ...
          <motion.div 
             ...
             className="relative z-10 bg-card/30 backdrop-blur-xl border border-border/60 p-6 md:p-12 rounded-3xl overflow-hidden shadow-2xl"
          >
      ...
      {/* Footer */}
      <footer className="border-t border-border/60 py-12 px-6 bg-background relative z-10 pb-[calc(3rem+env(safe-area-inset-bottom))]">
        ...
        >
            ...
            <div className="flex-1 w-full md:w-auto flex justify-center">
                 <motion.div 
                    ...
                    className="w-full max-w-sm aspect-square bg-gradient-to-br from-white/5 to-transparent rounded-3xl border border-border/60 relative overflow-hidden group hover:border-border transition-all shadow-2xl"
                 >
                    <div className="absolute inset-0 bg-primary/20 blur-[80px] group-hover:bg-primary/30 transition-all duration-700"></div>
                     ...
                     {icon && !image && (
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="bg-background/80 backdrop-blur-md p-6 rounded-2xl border border-border shadow-xl group-hover:scale-110 transition-transform duration-500">
                                {icon}
                            </div>
                        </div>
                     )}
